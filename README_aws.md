...
| Metric | Kết quả |
|---|---|
| Thời gian load data | 1.7059 seconds |
| Thời gian training | 1.1820 seconds |
| Best iteration | 1 |
| AUC-ROC | 0.906422 |
| Accuracy | 0.998999 |
| F1-Score | 0.746667 |
| Precision | 0.661417 |
| Recall | 0.857143 |
| Inference latency (1 row) | 0.3337 ms |
| Inference throughput (1000 rows) | 2260276.13 rows/second |
